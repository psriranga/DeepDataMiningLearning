...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/Users/sriranga/CMPE 255/DeepDataMiningLearning/data/cmpe258-sp4/WaymoCOCO/", type=str, help="dataset path")
    parser.add_argument("--annotationfile", default="", type=str, help="dataset annotation file path, e.g., coco json file")
    ...
    parser.add_argument("--model", default="customrcnn_resnet152", type=str, help="model name")
    ...
    parser.add_argument("--test-only", default=False, action="store_true", help="Only test the model")
